...
| `WIDGET_JWT_SECRET` | Server only | Yes | Min 32-char secret for signing short-lived widget JWTs. Prevents external callers from using the proxy. Generate: `node -e "console.log(require('crypto').randomBytes(32).toString('hex'))"` |
